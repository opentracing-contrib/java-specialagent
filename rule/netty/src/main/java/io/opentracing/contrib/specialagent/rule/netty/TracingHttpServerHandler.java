...
public class TracingHttpServerHandler extends CombinedChannelDuplexHandler<
    TracingServerChannelInboundHandlerAdapter, TracingServerChannelOutboundHandlerAdapter> {
