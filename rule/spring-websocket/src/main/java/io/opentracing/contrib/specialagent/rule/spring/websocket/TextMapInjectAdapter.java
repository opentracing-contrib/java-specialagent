...
/**
 * A TextMap carrier for use with Tracer.inject() to inject tracing context into
 * Spring messaging {@link MessageHeaders}.
 *
...
public class TextMapInjectAdapter implements TextMap {
  ...
  public TextMapInjectAdapter(final MessageBuilder<?> messageBuilder) {
