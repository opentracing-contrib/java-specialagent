...
public class InterceptUtil {
	...
	private static List<ServletFilterSpanDecorator> spanDecorators = new ArrayList<ServletFilterSpanDecorator>();
	...
	public static boolean isTraced(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
		if (skipPattern != null) {
	...
	private static ServletFilterSpanDecorator newSpanDecoratorInstance(String className) {
		try {
