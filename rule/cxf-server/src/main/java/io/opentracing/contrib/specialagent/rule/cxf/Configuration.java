...
public final class Configuration {
  ...
  public static final String INTERCEPTORS_SERVER_IN = "sa.integration.cxf-server.interceptors.in";
  public static final String INTERCEPTORS_SERVER_OUT = "sa.integration.cxf-server.interceptors.out";
