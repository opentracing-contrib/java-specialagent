...
public final class Configuration {
  ...
  public static final String INTERCEPTORS_CLIENT_IN = "sa.integration.cxf-client.interceptors.in";
  public static final String INTERCEPTORS_CLIENT_OUT = "sa.integration.cxf-client.interceptors.out";
  public static final String INTERCEPTORS_CLASSPATH = "sa.integration.cxf-client.interceptors.classpath";
