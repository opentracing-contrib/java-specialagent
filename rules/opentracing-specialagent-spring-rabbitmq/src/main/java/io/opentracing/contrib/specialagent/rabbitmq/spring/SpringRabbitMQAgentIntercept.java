...
public class SpringRabbitMQAgentIntercept {
  ...
  public static void onMessageEnter(Object msg) {
    ...
    final SpanBuilder builder = GlobalTracer.get().buildSpan("onMessage")
    ...
    if (message.getMessageProperties() != null) {
      ...
      SpanContext spanContext = GlobalTracer.get()
          .extract(Builtin.TEXT_MAP, new HeadersMapExtractAdapter(headers));
      if (spanContext != null) {
