...
import static io.opentracing.contrib.specialagent.spring40.web.copied.TracingListenableFutureCallback.captureException;

import io.opentracing.contrib.specialagent.spring40.web.copied.TracingAsyncRequestCallback;
import io.opentracing.contrib.specialagent.spring40.web.copied.TracingListenableFuture;
import io.opentracing.contrib.specialagent.spring40.web.copied.TracingListenableFutureCallback;
import io.opentracing.contrib.specialagent.spring40.web.copied.TracingRestTemplateInterceptor;
import java.net.URI;
