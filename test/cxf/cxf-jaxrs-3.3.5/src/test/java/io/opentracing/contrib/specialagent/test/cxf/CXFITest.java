...
public class CXFITest {
  ...
  public static void main(final String[] args) {
    System.setProperty("sa.integration.cxf-client.interceptors.in", ClientSpanTagInterceptor.class.getName());
    System.setProperty("sa.integration.cxf-server.interceptors.out", ServerSpanTagInterceptor.class.getName());
    System.setProperty("sa.integration.cxf-server.interceptors.classpath", "taget/test-classes");
    System.setProperty("sa.integration.cxf-client.interceptors.classpath", "taget/test-classes");
