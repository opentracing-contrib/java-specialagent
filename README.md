...
The latest stable release is: [1.5.2][main-release].

```bash
wget -O opentracing-specialagent-1.5.2.jar "http://central.maven.org/maven2/io/opentracing/contrib/specialagent/opentracing-specialagent/1.5.2/opentracing-specialagent-1.5.2.jar"
```

##### 2.1.1.2 Development

The latest development release is: <ins>1.5.3-SNAPSHOT</ins>.
```bash
wget -O opentracing-specialagent-1.5.3-SNAPSHOT.jar "https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=io.opentracing.contrib.specialagent&a=opentracing-specialagent&v=LATEST"
```
...
```bash
wget -O opentracing-specialagent-1.5.3-SNAPSHOT.jar $(curl -s https://oss.sonatype.org/content/repositories/snapshots/io/opentracing/contrib/specialagent/opentracing-specialagent/1.5.3-SNAPSHOT/ | grep '".*\d\.jar"' | tail -1 | awk -F\" '{print $2}')
```
...
1. The `default` profile is used for development of [<ins>Instrumentation Rules</ins>](#45-instrumentation-rule). It builds and runs tests for each rule, but _does not bundle the rules_ into [`opentracing-specialagent-1.5.2.jar`][main-release]
...
```bash
java -javaagent:opentracing-specialagent-1.5.2.jar -jar MyApp.jar
```
...
1. For jdk1.8
    ```bash
    java -Xbootclasspath/a:$JAVA_HOME/lib/tools.jar -jar opentracing-specialagent-1.5.2.jar <PID>
    ```

1. For jdk9+
    ```bash
    java -jar opentracing-specialagent-1.5.2.jar <PID>
    ```
...
```bash
java -javaagent:opentracing-specialagent-1.5.2.jar -Dsa.init.defer=false -jar MySpringBootApp.jar
```
...
[main-release]: http://central.maven.org/maven2/io/opentracing/contrib/specialagent/opentracing-specialagent/1.5.2/opentracing-specialagent-1.5.2.jar
[main-snapshot]: https://oss.sonatype.org/content/repositories/snapshots/io/opentracing/contrib/specialagent/opentracing-specialagent/1.5.3-SNAPSHOT
[test-release]: http://central.maven.org/maven2/io/opentracing/contrib/specialagent/opentracing-specialagent/1.5.2/opentracing-specialagent-1.5.2-tests.jar
[test-snapshot]: https://oss.sonatype.org/content/repositories/snapshots/io/opentracing/contrib/specialagent/opentracing-specialagent/1.5.3-SNAPSHOT