...
The latest stable release is: [1.3.2][main-release].

```bash
wget -O opentracing-specialagent-1.3.2.jar "http://central.maven.org/maven2/io/opentracing/contrib/specialagent/opentracing-specialagent/1.3.2/opentracing-specialagent-1.3.2.jar"
```

##### 2.1.1.2 Development

The latest development release is: <ins>1.3.3-SNAPSHOT</ins>.
```bash
wget -O opentracing-specialagent-1.3.3-SNAPSHOT.jar "https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=io.opentracing.contrib.specialagent&a=opentracing-specialagent&v=LATEST"
```
...
1. The `default` profile is used for development of [<ins>Instrumentation Rules</ins>](#45-instrumentation-rule). It builds and runs tests for each rule, but _does not bundle the rules_ into [`opentracing-specialagent-1.3.2.jar`][main-release]
...
1. The `assemble` profile is used to bundle the [<ins>Instrumentation Rules</ins>](#45-instrumentation-rule) into [`opentracing-specialagent-1.3.2.jar`][main-release]. It builds each rule, but _does not run tests._ Once the build with the `assemble` profile is finished, the [`opentracing-specialagent-1.3.2.jar`][main-release] will contain the built rules inside it.

    _**Note**: If you do not run this step, the [`opentracing-specialagent-1.3.2.jar`][main-release] from the previous step will not contain any [<ins>Instrumentation Plugins</ins>](#44-instrumentation-plugin) within it!_
...
```bash
java -javaagent:opentracing-specialagent-1.3.2.jar -jar MyApp.jar
```
...
1. For jdk1.8
    ```bash
    java -Xbootclasspath/a:$JAVA_HOME/lib/tools.jar -jar opentracing-specialagent-1.3.2.jar <PID>
    ```

1. For jdk9+
    ```bash
    java -jar opentracing-specialagent-1.3.2.jar <PID>
    ```
...
```bash
java -javaagent:opentracing-specialagent-1.3.2.jar -Dsa.spring -jar MySpringApp.jar
```
...
1. [AsyncHttpClient \[2.8.1,\]](https://github.com/opentracing-contrib/java-asynchttpclient)
1. [RabbitMQ Client \[5.6.0,\]](https://github.com/opentracing-contrib/java-rabbitmq-client)
...
1. [GRPC \[1.19.0,\]](https://github.com/opentracing-contrib/java-grpc)
1. [Jedis Client \[2.10.2,\]](https://github.com/opentracing-contrib/java-redis-client/tree/master/opentracing-redis-jedis)
1. [Apache HttpClient \[4.5.8\]](https://github.com/opentracing-contrib/java-apache-httpclient)
...
1. [Spring Web MVC \[5.1.6.RELEASE,\]](https://github.com/opentracing-contrib/java-spring-web)
1. [Spring WebFlux \[2.1.3.RELEASE,\]](https://github.com/opentracing-contrib/java-spring-web)
1. [Spring WebSocket STOMP \[5.1.7.RELEASE,\]](https://github.com/opentracing-contrib/java-spring-cloud/tree/master/instrument-starters/opentracing-spring-cloud-websocket-starter)
1. [Redisson \[0.1.7,\]](https://github.com/opentracing-contrib/java-redis-client/tree/master/opentracing-redis-redisson)
...
1. [Spring 3 Web MVC \[3.0.7.RELEASE,\]](https://github.com/opentracing-contrib/java-specialagent/tree/master/rules/specialagent-spring-webmvc)
1. [JAX-RS Client \[2.1.1,\]](https://github.com/opentracing-contrib/java-jaxrs)
...
[main-release]: http://central.maven.org/maven2/io/opentracing/contrib/specialagent/opentracing-specialagent/1.3.2/opentracing-specialagent-1.3.2.jar
[main-snapshot]: https://oss.sonatype.org/content/repositories/snapshots/io/opentracing/contrib/specialagent/opentracing-specialagent/1.3.3-SNAPSHOT
...
[test-release]: http://central.maven.org/maven2/io/opentracing/contrib/specialagent/opentracing-specialagent/1.3.2/opentracing-specialagent-1.3.2-tests.jar
[test-snapshot]: https://oss.sonatype.org/content/repositories/snapshots/io/opentracing/contrib/specialagent/opentracing-specialagent/1.3.3-SNAPSHOT