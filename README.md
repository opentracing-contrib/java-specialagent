...
15. [Jedis 2 Client](https://github.com/opentracing-contrib/java-redis-client/tree/master/opentracing-redis-jedis)
...
1. &nbsp;&nbsp;&nbsp;&nbsp;RELEASE: [`opentracing-specialagent-1.0.2.jar`][main-release]<br>
   SNAPSHOT: [`opentracing-specialagent-1.0.3-SNAPSHOT.jar`][main-snapshot]
...
1. &nbsp;&nbsp;&nbsp;&nbsp;RELEASE: [`opentracing-specialagent-1.0.2-tests.jar`][test-release]<br>
   SNAPSHOT: [`opentracing-specialagent-1.0.3-SNAPSHOT-tests.jar`][test-snapshot]
...
1. The `default` profile is used for development of <ins>Instrumentation Rules</ins>. It builds and runs tests for each rule, but _does not bundle the rules_ into [`opentracing-specialagent-1.0.2.jar`][main-release]
...
2. The `assemble` profile is used to bundle the <ins>Instrumentation Rules</ins> into [`opentracing-specialagent-1.0.2.jar`][main-release]. It builds each rule, but does not run tests. Once the build with the `assemble` profile is finished, the [`opentracing-specialagent-1.0.2.jar`][main-release] will contain the built rules inside it.

    _**Note**: If you do not run this step, the [`opentracing-specialagent-1.0.2.jar`][main-release] from the previous step will not contain any <ins>Instrumentation Plugins</ins> within it!_
...
[main-release]: http://central.maven.org/maven2/io/opentracing/contrib/specialagent/opentracing-specialagent/1.0.2/opentracing-specialagent-1.0.2.jar
[main-snapshot]: https://oss.sonatype.org/content/repositories/snapshots/io/opentracing/contrib/specialagent/opentracing-specialagent/1.0.3-SNAPSHOT
...
[test-release]: http://central.maven.org/maven2/io/opentracing/contrib/specialagent/opentracing-specialagent/1.0.2/opentracing-specialagent-1.0.2-tests.jar
[test-snapshot]: https://oss.sonatype.org/content/repositories/snapshots/io/opentracing/contrib/specialagent/opentracing-specialagent/1.0.3-SNAPSHOT