...
| [Mongo Driver](https://github.com/opentracing-contrib/java-mongo-driver) | [`mongo:driver`][mongo-driver] | 3.9.0 | 3.11.0 |
| [OkHttp][java-okhttp] | [`okhttp`][okhttp] | 3.5.0 | 4.0.0 |
