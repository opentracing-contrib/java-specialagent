...
public class ScheduledRunnableAgentPlugin implements AgentPlugin {
  @Override
...
//      .with(AgentBuilder.Listener.StreamWriting.toSystemError())
      ...
      .transform(new Transformer() {
        ...
        public Builder<?> transform(final Builder<?> builder, final TypeDescription typeDescription, final ClassLoader classLoader, final JavaModule module) {
          return builder.visit(Advice.to(ScheduledRunnableAgentPlugin.class).on(named("schedule").and(takesArguments(Runnable.class, long.class, TimeUnit.class))));
        }}));
  }
